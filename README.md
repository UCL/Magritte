# <img valign="middle" src="/docs/Images/Magritte_logo.png" alt="Magritte_logo" width="70"> Magritte   [![Build Status](https://travis-ci.com/UCL/Magritte.svg?token=j3NNTbFLxGaJNsSoKgCz&branch=master)](https://travis-ci.com/UCL/Magritte)
