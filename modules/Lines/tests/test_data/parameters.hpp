...
#define INPUTFILE      "grid.txt"

#define SPEC_DATAFILE  "species.txt"
#define REAC_DATAFILE  "rates.txt"

// Line data
#define DATA_FORMAT "LAMDA"
#define LINE_DATAFILES {"12CO.txt", "12C.txt", "12C+.txt", "16O.txt"}
