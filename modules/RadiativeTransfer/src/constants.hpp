...
const double H_4_weights[4] = {0.0458759, 0.454124, 0.454124, 0.0458759};
const double H_4_roots[4]   = {-1.6506801238857844, -0.5246476232752905, 0.5246476232752905, 1.6506801238857844};

const double H_5_weights[5] = {0.0112574, 0.222076, 0.533333, 0.222076, 0.0112574};
const double H_5_roots[5]   = {-2.0201828704560856, -0.9585724646138185, 0.0, 0.9585724646138185, 2.0201828704560856};

const double H_7_weights[7] = {0.0005482688559722185, 0.0307571239675865, 0.24012317860501253, 0.45714285714285724, 0.24012317860501253, 0.0307571239675865, 0.0005482688559722185};
const double H_7_roots[7]   = {-2.6519613568352334, -1.6735516287674714, -0.8162878828589648, 0.0, 0.8162878828589648, 1.6735516287674714, 2.6519613568352334};
