...
///    @param[in] *radiation: pointer to (previously calculated) radiation field
...
///    @param[out] *n: pointer to the resulting number of points along the ray
///    @param[out] *Su: pointer to the source for u extracted along the ray
///    @param[out] *Sv: pointer to the source for v extracted along the ray
///    @param[out] *dtau: pointer the optical depth increments along the ray 
////////////////////////////////////////////////////////////////////////////////////
