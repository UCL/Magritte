...
def  get_length (io_file, file_name):
    """
...
def read_word (io_file, file_name):
    """
...
def write_word (io_file, file_name, data):
    """
...
def read_number (io_file, file_name):
    ...
    Return the contents of the attribute
    """
    return int(read_word(io_file, file_name))
...
def write_number (io_file, file_name, data):
    ...
    Write the data to the attribute
    """
    write_word (io_file, file_name, data)
