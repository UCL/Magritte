...
TEST_CASE("Spline interpolations"){
  ...
  void spline( double *xa, double *ya, long n, double yp0, double ypn, double *d2ya );
  ...
  FILE *table = fopen("test_spline_table.txt", "w");
  ...
  FILE *func = fopen("test_spline_func.txt", "w");
