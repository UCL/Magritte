...
#define SPEC_DATAFILE  "data/species_full.txt"

#define REAC_DATAFILE  "data/rates_full.txt"

#define NLSPEC 5

#define LINE_DATAFILES {"data/12C.txt", "data/12C+.txt", "data/16O.txt", "data/SiO.txt","data/12CO.txt"}
...
#define G_EXTERNAL_Z 6.666670E+0
