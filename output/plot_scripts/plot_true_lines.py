...
file_name = "../files/" + date_stamp + "_output/true_level_populations_" + lspec + tag + ".txt"
...
plot_name = "../files/" + date_stamp + "_output/plots/true_level_populations_"+lspec+ tag +".png"
