...
///    @param[in] origin: number of cell for which transfer eq. is solved
///    @param[in] r: nuber or ray along which transfer eq. is solved
///    @param[out] u_local: Feautrier u field in cell "origin"
///    @param[out] v_local: Feautrier v field in cell "origin"
///    @param[out] L_local: approximated Lambda operator in cell "origin"
///////////////////////////////////////////////////////////////////////////////////

int solve_transfer (CELLS *cells, double *source, double *opacity, long origin,
                    long r, double *u_local, double *v_local, double *L_local)
{
...

  {
    ...
    long current = origin;
    long next    = cells.next (origin, r, current, &Z, &dZ);
    ...
    while (next != NCELLS)
    {
      ...
      double velocity = cells.relative_velocity (origin, r, next);
