                  ...
                  GRIDPOINT *gridpoint, EVALPOINT *evalpoint )
{
  ...
  printf("(ray_tracing): number of grid points     %*ld\n", MAX_WIDTH, ngrid);
  printf("(ray_tracing): number of HEALPix sides   %*ld\n", MAX_WIDTH, nsides);
  printf("(ray_tracing): number of HEALPix rays    %*ld\n", MAX_WIDTH, NRAYS);
...
*/
  ...
  #pragma omp parallel \
   ...
   shared( ngrid, gridpoint, nsides, unit_healpixvector, key, \
