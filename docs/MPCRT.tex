...
In order to obtain optimal perfomance one needs to start with an optimal memory layout for all data structures.
...
Array of structures (AoS) versus Structure of Arrays (SoA). Currently we use an array of structures called CELL. How to go to structure of arrays? Straightforwarrd for the location and data members.
