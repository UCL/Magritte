...
int main(){
  ...
  FILE *def_new = fopen("src/declarations.hpp", "w");



  /* Write the header */

  FILE *def_head = fopen("src/declarations_hd.txt", "r");
  ...
  FILE *def_std = fopen("src/declarations_std.txt", "r");
  ...
  cout << "(setup): declarations.hpp are set up \n\n";
