...
public:
    ...
    inline size_t order_min () const {return  order_min_.get();}
    inline size_t order_max () const {return  order_max_.get();}
    ...
    inline bool spherical_symmetry  () const {return spherical_symmetry_  .get();}
    inline bool adaptive_ray_tracing() const {return adaptive_ray_tracing_.get();}
