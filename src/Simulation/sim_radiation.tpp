...
#   pragma omp parallel default (shared)
    ...
    //for (int t = 0; t < nthrds; t++)
    //{
    //  dtaus.insert(dtaus.end(), rayPairs[t].dtaus.begin(), rayPairs[t].dtaus.end());
    //  dZs  .insert(dZs  .end(), rayPairs[t].dZs  .begin(), rayPairs[t].dZs  .end());
    //  chis .insert(chis .end(), rayPairs[t].chis .begin(), rayPairs[t].chis .end());
    //}
