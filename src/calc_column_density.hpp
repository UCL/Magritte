...
int calc_column_density (long ncells, CELLS *cells, RAYS rays, double *column_density, int spec);
...
double column_density (long ncells, CELLS *cells, RAYS rays, long o, int spec, long ray);
