...
int calc_column_density (long ncells, CELLS *cells, HEALPIXVECTORS healpixvectors, double *column_density, int spec);
...
double column_density (long ncells, CELLS *cells, HEALPIXVECTORS healpixvectors, long o, int spec, long ray);
